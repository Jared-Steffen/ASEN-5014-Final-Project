function Plot_Outputs(tspan,output_vecs,ref_inputs_vecs,subplot_title)
    ...
    yline(0.2*1.1,'-.','10% Overshoot','LabelVerticalAlignment','top','LineWidth',2)
    yline(0.2*1.02,':','2% Settling Time','LabelVerticalAlignment','top','LineWidth',2)
    yline(0.2*0.98,':','LineWidth',2)
    yline(0.2*0.95,'-.','95% Desired Reference','LabelVerticalAlignment','bottom','LineWidth',2)
    xline((5340+3600)/3600,'-.','1 Hour After Step Input','LabelVerticalAlignment','bottom','LineWidth',2)
    xline((5340+4400)/3600,':','1.25 Hours After Step Input','LabelVerticalAlignment','bottom','LineWidth',2)
    xlabel('Time [hr]')
    ...
    yline(1e-4*1.1,'-.','10% Overshoot','LabelVerticalAlignment','top','LineWidth',2)
    yline(1e-4*1.02,':','2% Settling Time','LabelVerticalAlignment','top','LineWidth',2)
    yline(1e-4*0.98,':','LineWidth',2)
    yline(1e-4*0.95,'-.','95% Desired Reference','LabelVerticalAlignment','bottom','LineWidth',2)
    xline((5340+3600)/3600,'-.','1 Hour After Step Input','LabelVerticalAlignment','bottom','LineWidth',2)
    xline((5340+4400)/3600,':','1.25 Hours After Step Input','LabelVerticalAlignment','bottom','LineWidth',2)
    xlabel('Time [hr]')
    ylabel('$\delta \theta$ [rad]','Interpreter','latex')
